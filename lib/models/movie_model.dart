...
class MovieModel with _$MovieModel{//_$ mixin을 적용(속성, 메서드 정의) ,$ 붙으면 그냥 freezed에 대한 private 클래스라고 보면 된다.
  const factory MovieModel({
    ...
    required List<ResultMovieModel> results, //Results class 아래에 새로 정의
  })=_MovieModel;
  factory MovieModel.fromJson(Map<String, dynamic> json) => _$MovieModelFromJson(json); //toJson, fromJson 생성된다
}
@freezed
abstract class ResultMovieModel with _$ResultMovieModel{
  factory ResultMovieModel({
    required bool adult,
  ...
  factory ResultMovieModel.fromJson(Map<String, dynamic> json) => _$ResultMovieModelFromJson(json);
}
